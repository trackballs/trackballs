...
void Bird::draw2() {
  ...
  */
  glDisable(GL_CULL_FACE);
  double angle=(0.8-(animation<0.5?animation*2.0:2.0-animation*2.0))*M_PI/2.0;
  ...
  glTexCoord2f(1.0,1.0); glVertex3f(0.0,size,0.0);
  glTexCoord2f(1.0,0.0); glVertex3f(0.0,0.0,0.0);
  glTexCoord2f(0.0,1.0); glVertex3f(size/2.*cos(angle),size,size/2.*sin(angle));
