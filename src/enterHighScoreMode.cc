...
void EnterHighScoreMode::display() {
  ...
  draw2DString(menuFont,str,(screenWidth-w)/2,(screenHeight-2*h)/2 + 0 * h, 220, 220, 64);
  snprintf(str,sizeof(str),"Enter your name: %s",name);
  TTF_SizeText(menuFont,str,&w,&h); h += 5;
  draw2DString(menuFont,str,(screenWidth-w)/2,(screenHeight-2*h)/2 + 1 * h, 220, 220, 64);
