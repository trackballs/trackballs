...
class Font {
 public:
  ...
  static int addText(int font, const char *text, int x, int y, float sx, float sy,
                     double delay, double offset, double stab, double ampl, int fix);
  static int drawSimpleText(int font, const char *text, int x, int y, float sx, float sy,
                            float r, float g, float b, float a);
  static int drawSimpleText3D(int font, const char *text, float sx, float sy);
  static int drawRightSimpleText(int font, const char *text, int x, int y, float sx, float sy,
                                 float r, float g, float b, float a);
  static int drawCenterSimpleText(int font, const char *text, int x, int y, float sx, float sy,
                                  float r, float g, float b, float a);
   ...
   */
  int l_addCenterText(const char *text, int x, int y, float sx, float sy, double delay,
                      double offset, double stab, double ampl, int fix);
  int l_addRightText(const char *text, int x, int y, float sx, float sy, double delay,
                     double offset, double stab, double ampl, int fix);
  int l_drawSimpleText(const char *text, int x, int y, float sx, float sy, float r, float g,
                       float b, float a);
  int l_drawRightSimpleText(const char *text, int x, int y, float sx, float sy, float r,
                            float g, float b, float a);
  int l_drawCenterSimpleText(const char *text, int x, int y, float sx, float sy, float r,
                             float g, float b, float a);
  ...
  void l_resetColor();
  int l_addText(const char *text, int x, int y, float sx, float sy, double delay,
                double offset, double stab, double ampl, int fix);
