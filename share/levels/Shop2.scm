...
(sign (_ "Extra life: 800 points") 1 20 -1 215 210)
(add-flag 215 210 -800 0 0.3)

(add-modpill 215.5 213.5 *mod-large* 30 0)
(sign (_ "Giant-package half a minute: 200 points") 1 20 -1 215 213)
(add-flag 215 213 -200 0 0.3)

(add-modpill 215.5 216.5 *mod-speed* 60 0)
(sign (_ "Speed-pill one minute: 200 points") 1 20 -1 215 216)
(add-flag 215 216 -200 0 0.3)

(add-modpill 215.5 219.5 *mod-nitro* 120 0)
(sign (_ "Nitro-speed two minutes: 1000 points") 1 20 -1 215 219)
